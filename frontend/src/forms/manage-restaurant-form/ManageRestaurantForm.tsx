...
const ManageRestaurantForm = ({ onSave, isLoading, restaurant }: Props) => {
  ...
  useEffect(() => {
    ...
    const menuItemsFormatted = restaurant.menuItems.map((item) => ({
      ...item,
      price: parseInt((item.price / 100).toFixed(2)), //parsInt is used to convert the price to a whole number
    }));
    ...
    form.reset(updatedRestaurant); //reset the form with the updated restaurant data
  }, [form, restaurant]);
